      ...
      >
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 mb-2">
            <p className="text-text-muted text-xs sm:text-sm md:text-base font-mono whitespace-nowrap">Featured Project</p>
          ...
          <div className="professional-card p-4 sm:p-5 md:p-6 lg:p-8 rounded-xl hover-lift">
            <p className="text-text-secondary leading-relaxed text-sm sm:text-base md:text-lg mb-4 sm:mb-5 md:mb-6 break-words">
              {project.description}
            </p>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {project.technologies.map((tech, techIndex) => (
                <span 
                  key={techIndex} 
                  className="px-2.5 sm:px-3 md:px-4 py-1.5 bg-background-secondary text-text-secondary text-xs sm:text-sm md:text-base font-medium rounded-md border border-border-default hover:border-border-light hover:bg-background-tertiary active:bg-background-tertiary transition-all duration-200 touch-manipulation break-words"
                >
                  {tech}
                </span>
              ))}
  ...
  return (
    ...
    >
      ...
      {selectedProject && (
        ...
        >
          <div 
            className="relative bg-background-primary rounded-none sm:rounded-2xl shadow-2xl max-w-4xl w-full h-full sm:h-auto sm:max-h-[90vh] flex flex-col animate-fade-in-up"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button - Inside modal, top right */}
            <button
              onClick={closeModal}
              className="absolute top-4 right-4 z-[1200] w-10 h-10 rounded-full bg-background-secondary hover:bg-background-tertiary flex items-center justify-center transition-colors duration-200 shadow-lg"
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 lg:p-10 pt-12 sm:pt-6">
              ...
              {projectImages.length > 0 && (
                <div 
                  className="relative w-full h-[250px] sm:h-[300px] md:h-[400px] rounded-xl overflow-hidden mb-6 bg-background-secondary"
              ...
              {/* Project Title */}
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-text-primary mb-4 break-words">
                {selectedProject.title}
              </h3>

              {/* Description */}
              <p className="text-text-secondary leading-relaxed text-base sm:text-lg md:text-xl mb-6 break-words">
                {selectedProject.description}
              </p>

              {/* Technologies */}
              <div className="mb-6">
                <h4 className="text-sm sm:text-base font-semibold text-text-muted uppercase tracking-wide mb-3">
                  Technologies Used
                </h4>
                <div className="flex flex-wrap gap-2 sm:gap-3">
                  {selectedProject.technologies.map((tech, techIndex) => (
                    <span 
                      key={techIndex} 
                      className="px-3 sm:px-4 py-2 bg-background-secondary text-text-secondary text-sm sm:text-base font-medium rounded-md border border-border-default break-words"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              {/* Links */}
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 border-t border-border-default">
                ...
                {selectedProject.githubUrl && selectedProject.githubUrl !== '#' && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-background-secondary text-text-primary rounded-lg font-semibold border border-border-default transition-all duration-200 hover:bg-background-tertiary hover-lift"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
