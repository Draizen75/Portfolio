          ...
          {skills.map((skill, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="group relative w-full p-4 sm:p-5 md:p-6 rounded-xl bg-background-secondary/50 border border-border-default/50 hover:border-accent-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-accent-primary/20 hover:-translate-y-1 cursor-pointer">
                    ...
                    <div className="mb-3 flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                      {hasIcon && iconData ? (
                        ...
                        <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-background-tertiary rounded flex items-center justify-center group-hover:bg-accent-primary/10 transition-colors duration-300">
                          <span className="text-xs sm:text-sm text-text-secondary font-medium group-hover:text-accent-primary transition-colors duration-300">{skill}</span>
                        </div>
                      )}
                    </div>
                    
                    {/* Label */}
                    <span className="text-text-primary text-xs sm:text-sm text-center font-normal break-words group-hover:text-accent-primary transition-colors duration-300">
                      {skill}
                    </span>
                  </div>
                </div>
