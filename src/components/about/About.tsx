        ...
        <div className="space-y-12 sm:space-y-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-text-primary dark:text-white tracking-tight">Education</h3>
            </div>
            
            <div className="relative pl-8 sm:pl-12 border-l-2 border-border-default dark:border-gray-700">
              {education.map((edu, index) => (
                ...
                >
                  <div className="absolute -left-[29px] sm:-left-[37px] top-1 w-6 h-6 rounded-full bg-accent-primary border-4 border-background-secondary dark:border-gray-800 flex items-center justify-center">
                  ...
                  <div className="group professional-card p-5 sm:p-6 md:p-7 rounded-xl hover-lift relative">
                    ...
                    <div className="sm:pr-24 md:pr-32 lg:pr-36">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between sm:gap-4 mb-2">
                        <h4 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-text-primary dark:text-white group-hover:text-accent-primary transition-colors duration-300 break-words flex-1 tracking-tight">
                          {edu.degree}
                        </h4>
                      ...
                      <ul className="space-y-2 mt-2">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-text-secondary dark:text-gray-200 leading-relaxed text-sm sm:text-base break-words">
          ...
          <div className="space-y-6 mt-12 sm:mt-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-text-primary dark:text-white tracking-tight">Experience</h3>
            </div>
                ...
                >
                  ...
                  <div className="group professional-card p-5 sm:p-6 md:p-7 rounded-xl hover-lift relative">
                    ...
                    <div className="sm:pr-24 md:pr-32 lg:pr-36">
                      ...
                      <p className="text-accent-primary dark:text-blue-400 font-semibold text-base sm:text-lg mb-4 break-words">
                        {work.company}
                      </p>
          ...
          <div className="space-y-6 mt-12 sm:mt-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-text-primary dark:text-white tracking-tight">Certifications</h3>
            </div>
              ...
              {certifications.map((cert, index) => (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="inline-flex items-center px-3 py-1 rounded-full bg-background-secondary dark:bg-gray-700 text-text-muted dark:text-gray-300 text-xs font-mono">
                      {cert.period}
                    </span>
                  </div>
                  
                  <h4 className="text-lg sm:text-xl md:text-2xl font-extrabold text-text-primary dark:text-white mb-2 group-hover:text-accent-primary transition-colors duration-300 break-words tracking-tight">
                    {cert.title}
                  </h4>
                  ...
                  <p className="text-text-secondary dark:text-gray-200 leading-relaxed text-sm sm:text-base break-words">
                    {cert.description}
                  </p>
                </div>
              ))}
