        ...
        <div className="space-y-12 sm:space-y-16">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-text-primary dark:text-white">Education</h3>
            </div>
                  ...
                  <div className="group professional-card p-5 sm:p-6 md:p-7 rounded-xl hover-lift relative">
                    ...
                    <div className="sm:pr-24 md:pr-32 lg:pr-36">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between sm:gap-4 mb-2">
                        <h4 className="text-xl sm:text-2xl md:text-3xl font-bold text-text-primary dark:text-white group-hover:text-accent-primary transition-colors duration-300 break-words flex-1">
                          {edu.degree}
                        </h4>
          ...
          <div className="space-y-6 mt-12 sm:mt-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-text-primary dark:text-white">Experience</h3>
            </div>
          ...
          <div className="space-y-6 mt-12 sm:mt-16">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-text-primary dark:text-white">Certifications</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {certifications.map((cert, index) => (
                ...
                >
                  ...
                  <h4 className="text-lg sm:text-xl font-bold text-text-primary dark:text-white mb-2 group-hover:text-accent-primary transition-colors duration-300 break-words">
                    {cert.title}
                  </h4>
