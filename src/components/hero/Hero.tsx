...
const Hero = ({ onSectionClick }: HeroProps): React.JSX.Element => {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 md:pb-0 relative overflow-hidden bg-background-primary">
      ...
      <div className="max-w-[1200px] w-full flex flex-col items-center justify-center text-center relative z-10 my-auto">
        <div className="animate-fade-in-up space-y-4 sm:space-y-5 md:space-y-6 w-full max-w-[800px]">
          <p className="text-text-secondary text-base sm:text-base md:text-lg font-mono tracking-wider mb-2 sm:mb-3 md:mb-4">
            Hi, I'm
          </p>
          ...
          <h2 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-text-secondary leading-tight break-words mt-2 sm:mt-3">
            Web Developer & Data Analyst
          </h2>
          
          <p className="text-base sm:text-base md:text-lg lg:text-xl leading-relaxed text-text-muted max-w-[600px] mx-auto break-words px-2 sm:px-4 md:px-0 mt-4 sm:mt-5 md:mt-6">
